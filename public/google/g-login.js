...
let backEndUrl = 'http://localhost:5500';

const redirection_uri = 'http://localhost:5500/google/dashboard.html'
...
async function getAccessToken(code) {
    let api_result = await fetch(`${backEndUrl}/validateCode?code=${code}&uri=${redirection_uri}`);
